...
\pretitle{\vspace{-150pt} \begin{center} \HorRule \fontsize{40}{40} \usefont{OT1}{ptm}{b}{n} \color{DarkRed} \selectfont} % Horizontal rule before the title
...
\begin{tabular}{ccc}
  ...
  \org Kitware,Inc. & \org Kitware, Inc., SUNY Albany & \org Kitware, Inc., SUNY Albany
\end{tabular}}
