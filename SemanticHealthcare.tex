...
\begin{document}
  ...
  \initial{S}\textit{ystematized Nomenclature in Medicine - Clinical Terms ( SNOMED CT )}\
   ...
   and analyze clinical data. SNOMED CT is a used widely to achieve semantic uniformity\
   and consistency of health terms as well as to achieve interoperability between HL7\
   (Health Level 7) based health frameworks and other healthcare entities\
   \cite{ryan_towards_2006,arguello_executing_2009,khan_achieving_2012}.\
